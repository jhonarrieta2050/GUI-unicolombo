 ...
 * @author JEREMY
 */
public class Ventana_visual26 extends javax.swing.JFrame {
 JButton vBotones[];
    /**
     * Creates new form Ventana_visual26
     */
    public Ventana_visual26() {
        initComponents();
        CreacionVentana();
    }
   ...
   public void CreacionVentana(){
       ...
       this.setTitle("Ejemplo de vectores y evenyos");
   ...
   public void botonesActionPerformed(ActionEvent evt) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_visual26.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_visual26().setVisible(true);
            }
        });
    }
