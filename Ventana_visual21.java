...
public class Ventana_visual21 extends javax.swing.JFrame {
JLabel etiNum1;
JLabel etiNum2;
JTextField txtNum1;
JTextField txtNum2;
...
JButton btnResta;
    /**
     * Creates new form Ventana_visual21
     */
    public Ventana_visual21() {
        initComponents();
        CreacionVentana();
    }
public void CreacionVentana(){
    ...
    btnResta.setBounds(150,120,100,20);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_visual21.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_visual21().setVisible(true);
            }
        });
    }
