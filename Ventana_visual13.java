 ...
 * @author JEREMY
 */
public class Ventana_visual13 extends javax.swing.JFrame {

    /**
     * Creates new form Ventana_visual13
     */
    public Ventana_visual13() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_visual13.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_visual13().setVisible(true);
            }
        });
    }
