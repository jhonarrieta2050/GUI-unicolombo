 ...
 * @author JEREMY
 */
public class Ventana_visual11 extends javax.swing.JFrame {

    /**
     * Creates new form Ventana_visual11
     */
    public Ventana_visual11() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jMenu2.add(menuItemRojo);

        menuItemVerde.setText("Verde");
        jMenu2.add(menuItemVerde);

        menuItemAzul.setText("Azul");
        jMenu2.add(menuItemAzul);
...
this.getContentPane().setBackground(Color.RED);       
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_visual11.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_visual11().setVisible(true);
            }
        });
    }
