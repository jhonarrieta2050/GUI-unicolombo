 ...
 * @author JEREMY
 */
public class Ventana_visual24 extends javax.swing.JFrame {
JCheckBox vcuadros[];
JButton btnAceptar;
    /**
     * Creates new form Ventana_visual24
     */
    public Ventana_visual24() {
        initComponents();
        CreacionVentana();
    }
    ...
    this.setTitle("Ejemple de vector de componentes");
...
public void bntAceptarActionPerformed(ActionEvent evt){
int i;
int cont=0;
...
JOptionPane.showMessageDialog(null, "Hay " +cont+ " cuadros seleccionados");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_visual24.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_visual24().setVisible(true);
            }
        });
    }
